      ...
      <div className="container mx-auto pt-6 lg:px-0 md:px-3 py-6">
        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-2">
          <div className="space-y-3 justify-between px-6">
            ...
            <br></br>
            <p className="text-s">
              The New Wagon R S-CNG features a factory-fitted S-CNG kit that
              has a leak proof design to help ensure that safety is not
              compromised. The use of advanced components contributes to the
              engine’s longer lifespan. The New Wagon R S-CNG by Maruti Suzuki
              comes equipped with dual interdependent ECUs and an Intelligent
              Injection System, with which it manages to offer smoother pickup,
              great drivability, and an overall superior performance.
            </p>
            <br></br>
